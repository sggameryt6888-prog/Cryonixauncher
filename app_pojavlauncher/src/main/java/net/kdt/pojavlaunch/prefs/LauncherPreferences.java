...
public class LauncherPreferences {
    ...
    public static String PREF_LAUNCHER_THEME = "blue";
    public static String PREF_CUSTOM_MOUSE_PATH = "";
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_LAUNCHER_THEME = DEFAULT_PREF.getString("launcherTheme", "blue");
        PREF_CUSTOM_MOUSE_PATH = DEFAULT_PREF.getString("customMousePath", "");
