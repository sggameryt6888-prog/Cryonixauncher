...
public class SearchModFragment extends Fragment implements ModItemAdapter.SearchResultCallback {
    ...
    private String[] mProjectTypeValues;
    ...
    public SearchModFragment(){
        ...
        mSearchFilters.setProjectType(SearchFilters.TYPE_MODPACK);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mProjectTypeSpinner = view.findViewById(R.id.search_mod_type_spinner);
        mProjectTypeValues = getResources().getStringArray(R.array.search_mod_project_type_values);
        ...
        mProjectTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View selectedView, int position, long id) {
                if(position < 0 || position >= mProjectTypeValues.length) return;
                String nextProjectType = mProjectTypeValues[position];
                if(nextProjectType.equals(mSearchFilters.projectType)) return;
                mSearchFilters.setProjectType(nextProjectType);
                searchMods(mSearchEditText.getText().toString());
            }
